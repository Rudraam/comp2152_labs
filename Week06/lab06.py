...
# Lab 06 - Question 5
last_saved_game = functions_lab06.load_saved_game()
print(f"      |    Loaded game: {last_saved_game}")
...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    # Lab 06 - Question 5b
    combat_strength, m_combat_strength = functions_lab06.adjust_combat_strengths(last_saved_game, combat_strength, m_combat_strength)

    # Print the adjusted combat strengths for verification
...
combat_strength = 5 
if num_dream_lvls > 0:
    # Update: Call inception_dream with only num_dream_lvls
    crazy_level = functions_lab06.inception_dream(num_dream_lvls)
    # Handle health points reduction separately
    health_points -= 1
    combat_strength += crazy_level
print(f"Updated combat strength: {combat_strength}")
print(f"Remaining health points: {health_points}")
print("    |", end="    ")
...
print("Loading previous game data...")
last_saved_game = functions_lab06.load_saved_game()
print(f"Previous game result: {last_saved_game}")
combat_strength, m_combat_strength = functions_lab06.adjust_combat_strengths(last_saved_game, combat_strength, m_combat_strength)
num_dream_lvls = -1
while num_dream_lvls not in range(0, 4):
    try:
