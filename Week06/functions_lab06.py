...
def load_saved_game(file_name="save.txt"):
    try:
        with open(file_name, "r") as file:
            ...
            if lines:
                ...
                print(f"    |    Loaded game data: {last_line}")
                return last_line
            else:
...
def adjust_combat_strengths(last_line, hero_combat_strength, monster_combat_strength):
    if last_line:
        ...
        # Check if the monster won the previous game
            ...
            print("    |    No adjustments to combat strengths.")
    else:
