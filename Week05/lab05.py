...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    loot_options , belt = functions_lab05.collect_loot(loot_options)
    print("    ------------------------------------------------------------------")
    print("    |", end="    ")
    ...
    loot_options , health_points = functions_lab05.collect_loot(loot_options)
    ...
    while input_invalid and tries in range(5):
        ...
        if len(name) != 2:
            ...
            if name[0] or not name[1].isalpha():
